...
<template>
    <div class="articlePreview" @click="onClick">
        <div class="imageCol">
            <img v-if="article.category === 'Finance'" src="../assets/FinanceImage.png"/>
            <img v-else-if="article.category === 'Sport'" src="../assets/SportImage.png"/>
            <img v-else-if="article.category === 'Technology'" src="../assets/TechnologyImage.png"/>
            <img v-else src="../assets/BreakingNews.png"/>
        </div>
        <div class="content">
            <h3>{{ previewTitle }}</h3>
