...
class ArticleComment(models.Model):
    ...
    article_id = models.ForeignKey('Article', related_name='comment', null=False, blank=False, on_delete=models.CASCADE)  # TODO: Replace with relationship to Article model
